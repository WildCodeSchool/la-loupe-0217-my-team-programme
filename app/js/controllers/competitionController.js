angular.module('app')
    .controller('competitionController', function($scope, $timeout, competitionService, ApiServices) {
        ...
        $scope.update = function() {
            competitionService.getMatchDay($scope.currentMatchday).then(function(res) {
                ...
                $scope.matchsDay.forEach(function(match){
                  ...
                  ApiServices.getOne(idHome).then(function(res) {
                      match.logoHomeTeam = res.data.crestUrl;
                  });

                  ApiServices.getOne(idAway).then(function(res) {
